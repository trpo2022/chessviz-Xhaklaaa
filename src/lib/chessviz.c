    ...
    for(int i=0;i<8;i++){
        for(int j=0;j<8;j++){
            ...
            case 'q':
                ...
                while((q1!=k1||q2!=k2)&&((x!=0&&q2==k2)||(y!=0&&q1==k1)||(y!=0&&x!=0))){
                    q1+=x;
                    q2+=y;
                    if(board[q1][q2]!=' '){
                        flag++;
            ...
            case 'r':
                ...
                while((q1!=k1||q2!=k2)&&((x!=0&&q2==k2)||(y!=0&&q1==k1))){
                    q1+=x;
                    q2+=y;
                    if(board[q1][q2]!=' '){
                        flag++;
...
void WhitePawn(char board[8][8], char w[7]){
    int flag=0;
    int x1,y1,x2,y2;
    if(w[1]>='1'&&w[1]<='8'&&w[2]=='-'&&w[3]>='a'&&w[3]<='h'&&w[4]>='1'&&w[4]<='8'&&(w[5]=='\0'||w[5]=='#')){
        x1= ParseX(w[0]);
        y1 = ParseY(w[1]);
        x2 = ParseX(w[3]);
        y2 = ParseY(w[4]);
    ...
    if((x1==x2&&y1+1==y2)||(x1==x2&&y1==1&&y2==3)||(board[y2][x2]=='p'&&y1+1==y2&&(x1+1==x2||x1-1==x2))||(board[y2-1][x2]=='p'&&y1+1==y2&&(x1+1==x2||x1-1==x2)&&w_pass==1&&w_x==x2)){
     //(Move||Move from 6 to 4 line||Take||En passant)
        if(flag==0){
            board[y1][x1]=' ';
            board[y2][x2]='P';
            if(board[y2-1][x2]=='p'&&y1+1==y2&&(x1+1==x2||x1-1==x2)&&w_pass==1&&w_x==x2){
                board[y2-1][x2]=' ';
            }
            Show(board);
        }
...
void BlackPawn(char board[8][8], char b[7]){
    int flag=0;
    int x1,y1,x2,y2;
    if(b[1]>='1'&&b[1]<='8'&&b[2]=='-'&&b[3]>='a'&&b[3]<='h'&&b[4]>='1'&&b[4]<='8'&&(b[5]=='\0'||b[5]=='#')){
        x1= ParseX(b[0]);
        y1 = ParseY(b[1]);
        x2 = ParseX(b[3]);
        y2 = ParseY(b[4]);
    ...
    if((x1==x2&&y1-1==y2)||(x1==x2&&y1==6&&y2==4)||(board[y2][x2]=='P'&&y1-1==y2&&(x1+1==x2||x1-1==x2))||(board[y2+1][x2]=='P'&&y1-1==y2&&(x1+1==x2||x1-1==x2)&&b_pass==1&&b_x==x2)){
        if(flag==0){
            board[y1][x1]=' ';
            board[y2][x2]='p';
            if(board[y2+1][x2]=='P'&&y1-1==y2&&(x1+1==x2||x1-1==x2)&&b_pass==1&&b_x==x2){
                board[y2+1][x2]=' ';
            }
            Show(board);
        }
...
void WhiteKing(char board[8][8],char w[7]){
    int flag=0;
    int x1,y1,x2,y2;
    if(w[1]>='a'&&w[1]<='h'&&w[2]>='1'&&w[2]<='8'&&w[3]=='-'&&w[4]>='a'&&w[4]<='h'&&w[5]>='1'&&w[5]<='8'&&(w[6]=='\0'||w[6]=='#')){
        x1= ParseX(w[1]);
        y1 = ParseY(w[2]);
        x2 = ParseX(w[4]);
        y2 = ParseY(w[5]);
    ...
    if(flag==0){
        ...
        int xs=abs(x1-x2);
        int ys=abs(y1-y2);
        if((xs==1&&ys==1)||(xs==0&&ys==1)||(xs==1&&ys==1)){
            char mas[8][8];
            for(int i=0;i<8;i++){
                for(int j=0;j<8;j++){
                    mas[i][j]=board[i][j];
...
void BlackKing(char board[8][8],char b[7]){
    int flag=0;
    int x1,y1,x2,y2;
    if(b[1]>='a'&&b[1]<='h'&&b[2]>='1'&&b[2]<='8'&&b[3]=='-'&&b[4]>='a'&&b[4]<='h'&&b[5]>='1'&&b[5]<='8'&&(b[6]=='\0'||b[6]=='#')){
        x1= ParseX(b[1]);
        y1 = ParseY(b[2]);
        x2 = ParseX(b[4]);
        y2 = ParseY(b[5]);
